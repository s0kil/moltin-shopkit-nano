<script>
  ...
  function handleClick() {
    switch (route) {
      case "billing":
        if (completed) return modal.dispatch("closeModal");

        return modal.dispatch("goToShipping");
      ...
      case "shipping": {
        ...
        return modal.dispatch("goToCart");
      }

      default:
        return modal.dispatch("closeModal");
    }
  }
</script>
...
<div class="header">
  <Button buttonType="action" on:click={handleClick}>
    {#if route === 'shipping' || (route === 'billing' && !completed)}
      <svg
        ...
        <defs>
          <path
            id="back-a"
            d="M12.6560648,15.0712296 L21.5802486,15.0712296
            ...
            16.619888,11.085247 L12.6560648,15.0712296 Z" />
        </defs>
        <use
          fill-rule="evenodd"
    ...
    {:else}
      <svg
        ...
        <defs>
          <path
            id="cross2-a"
            d="M16,14.5857864 L19.2928932,11.2928932 C19.6834175,10.9023689
            ...
            12.3165825,10.9023689 12.7071068,11.2928932 L16,14.5857864 Z" />
        </defs>
        <use
          fill-rule="evenodd"
